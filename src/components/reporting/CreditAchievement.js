...
const CreditAchievement = () => {
    const [achievements, setAchievements] = useState(null);

    useEffect(() => {
        const fetchAchievements = () => {
            apiAuth
                .get(`/reporting/creditachievementsummary`)
                .then(res => {
    ...
    return (
        <Card>
            <CardBody>
                <h4 className="header-title mt-0">Credit Achievement Summary</h4>
...
export default CreditAchievement;