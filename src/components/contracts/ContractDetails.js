...
export default ({ id }) => {
    ...
    return (
        <Card style={{backgroundColor: (details !== null && details !== false && details.amount_pending == details.total_payable && details.amount_pending !== 0 && details.overdue_index !== 0) ? '#f7aba6' : ''}}>
            <CardBody>
