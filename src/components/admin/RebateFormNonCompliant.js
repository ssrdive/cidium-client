...
const RebateFormNonCompliant = ({ valid, id, onAfterSubmit }) => {
    ...
    return (
        <Card>
            <CardBody>
                <h4 className="header-title mt-0">Create Rebate (Non-Compliant)</h4>
                <Row>
                    <Col>
                        {valid ? (
                            <>
...
export default RebateFormNonCompliant;
